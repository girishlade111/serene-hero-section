    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/10 backdrop-blur-sm py-4 px-6">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <div className="text-white font-serif text-xl">Calm</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl fade-in">
            ...
            <p className="font-sans text-gray-200 text-lg lg:text-xl font-light leading-relaxed mb-12 max-w-xl">
              Discover tranquility through mindful meditation and embrace the profound stillness that exists between
              thoughts and breath.
            </p>
      ...
      <div className="absolute bottom-6 left-0 right-0 z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center">
            <p className="font-sans text-white/70 text-xs font-light">© 2025 Calm. All rights reserved.</p>
            <p className="font-sans text-white/70 text-xs font-light">Crafted with mindfulness</p>
          </div>
        </div>
      </div>
    </div>
